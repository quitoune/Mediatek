...
class FormatRepository extends ServiceEntityRepository
{
    ...
    /**
     * Retourne une liste de catégories paginé en fonction de l'ordre et de la recherche courante
     *
     * @param int $page
     * @param int $max
     * @param array $params
    ...
    /**
     * Récupération des catégories pour un livre
     *
     * @return mixed|\Doctrine\DBAL\Driver\Statement|array|NULL
     */
    public function getAllFormats()
    {
        return $this->createQueryBuilder('for')
        ->orderBy('for.nom')
        ->getQuery()
        ->getResult();
    }
     ...
     * @return mixed|\Doctrine\DBAL\Driver\Statement|array|NULL
     */
    public function getFormatsForBooks()
    {
        return $this->createQueryBuilder('for')
        ->andWhere('for.objet != 2')
        ->orderBy('for.nom')
        ->getQuery()
        ->getResult();
    }
    ...
    /**
     * Récupération des catégories pour un film
     *
     * @return mixed|\Doctrine\DBAL\Driver\Statement|array|NULL
     */
    public function getFormatsForMovies()
    {
        return $this->createQueryBuilder('for')
        ->andWhere('for.objet != 1')
        ->orderBy('for.nom')
        ->getQuery()
        ->getResult();
    }
